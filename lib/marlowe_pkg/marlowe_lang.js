...
/**
 */
export const WasmPayeeType = Object.freeze({
  AccountRole: 0,
  0: "AccountRole",
  AccountAddress: 1,
  1: "AccountAddress",
...
/**
 */
export const WasmTransactionWarningType = Object.freeze({
  Failed: 0,
  0: "Failed",
  TransactionNonPositiveDeposit: 1,
  1: "TransactionNonPositiveDeposit",
  TransactionNonPositivePay: 2,
  2: "TransactionNonPositivePay",
  TransactionPartialPay: 3,
  3: "TransactionPartialPay",
  TransactionShadowing: 4,
  4: "TransactionShadowing"
});
/**
 */
export const WasmMachineStateEnum = Object.freeze({
  WaitingForInput: 0,
  0: "WaitingForInput",
  ReadyForNextStep: 1,
  1: "ReadyForNextStep",
  ContractHasTimedOut: 2,
  2: "ContractHasTimedOut",
  Closed: 3,
  3: "Closed",
  Faulted: 4,
  4: "Faulted"
...
export class WASMMarloweStateMachine {
  ...
  apply_input_deposit_for_role(from_role, to_role, token_name, currency_symbol, quantity) {
    ...
    wasm.wasmmarlowestatemachine_apply_input_deposit_for_role(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
  ...
  apply_input_deposit_for_addr(from_bech32_addr, to_bech32_addr, token_name, currency_symbol, quantity) {
    ...
    const ptr4 = passStringToWasm0(quantity, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
    const len4 = WASM_VECTOR_LEN;
    wasm.wasmmarlowestatemachine_apply_input_deposit_for_addr(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
...
export class WasmMachineState {
  ...
  set next_timeout(arg0) {
    wasm.__wbg_set_wasmmachinestate_next_timeout(
      this.__wbg_ptr,
      !isLikeNone(arg0),
