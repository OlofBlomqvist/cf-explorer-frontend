...
export class WASMMarloweStateMachine {
   ...
   * @param {string} quantity
   */
  apply_input_deposit_for_addr(
    from_bech32_addr: string,
    to_bech32_addr: string,
    token_name: string,
    currency_symbol: string,
    quantity: string
  ): void;
...
export interface InitOutput {
  ...
  readonly wasmmarlowestatemachine_set_acc_of_addr: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly wasmmarlowestatemachine_set_acc_of_role: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly wasmmarlowestatemachine_apply_input_deposit_for_role: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly wasmmarlowestatemachine_apply_input_deposit_for_addr: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly wasmmarlowestatemachine_apply_input_choice_for_role: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly wasmmarlowestatemachine_apply_input_choice_for_addr: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly __wbg_set_wasmtransactionwarningtransactionshadowing_is_now_assigned_i128: (
    a: number,
    b: number,
    c: number
  ) => void;
  ...
  readonly __wbg_set_wasmtransactionwarningtransactionpartialpay_asked_to_pay_i128: (
    a: number,
    b: number,
    c: number
  ) => void;
  ...
  readonly __wbg_set_wasmtransactionwarningtransactionpartialpay_but_only_paid_i128: (
    a: number,
    b: number,
    c: number
  ) => void;
  ...
  readonly __wbg_get_wasmtransactionwarningtransactiontransactionnonpositivepay_asked_to_pay_i128: (
    a: number,
    b: number
  ) => void;
  ...
  readonly __wbg_set_wasmtransactionwarningtransactiontransactionnonpositivepay_of_token: (
    a: number,
    b: number
  ) => void;
  readonly __wbg_set_wasmtransactionwarningtransactiontransactionnonpositivepay_to_payee: (
    a: number,
    b: number
  ) => void;
  ...
  readonly __wbg_set_wasmtransactionwarningtransactionnonpositivedeposit_asked_to_deposit_i128: (
    a: number,
    b: number,
    c: number
  ) => void;
  ...
  readonly __wbg_set_wasmtransactionwarningtransactiontransactionnonpositivepay_asked_to_pay_i128: (
    a: number,
    b: number,
    c: number
  ) => void;
  ...
  readonly __wbg_set_wasmtransactionwarningtransactionshadowing_had_value_i128: (
    a: number,
    b: number,
    c: number
  ) => void;
  ...
  readonly __wbg_get_wasmtransactionwarningtransactionnonpositivedeposit_asked_to_deposit_i128: (
    a: number,
    b: number
  ) => void;
